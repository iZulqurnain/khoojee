...
from invoker.core.phone.services.sim_data import SimData
from invoker.core.phone.services.sim_location import SimLocation
from invoker.core.phone.services.teleem_pk import TeleemPk
...
class Search:
    ...
    def get_report(self):
        ...
        pak_data_obj = SimData(self.__MOBILE_NUMBER__)
