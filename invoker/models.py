...
class SearchedPhoneNumberModel(models.Model):
    phone_number = models.BigIntegerField(unique=True, db_index=True, default=None, null=False)
    details_found = models.BooleanField(default=False, null=False)
    is_public_allowed = models.BigIntegerField(default=True, null=False)
    is_search_completed = models.BooleanField(default=False, null=False)
...
class NumberDetailModel(models.Model):
    phone_number = models.ForeignKey(SearchedPhoneNumberModel, on_delete=models.CASCADE)
...
class HavingErrorNumberModel(models.Model):
    phone_number = models.OneToOneField(SearchedPhoneNumberModel, on_delete=models.CASCADE)
